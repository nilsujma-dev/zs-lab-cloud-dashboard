...
RESOURCES: list[tuple[str, str, dict[str, Any], dict[str, Any], list[str]]] = [
    ...
    ("aws_route_table", "public", {"tags": {"Name": "zpa-lab-public-rt"}},
     {"vpc_id": {"references": ["aws_vpc.lab.id", "aws_vpc.lab"]},
      "route": [{"cidr_block": {"constant_value": "0.0.0.0/0"}, "gateway_id": {"references": ["aws_internet_gateway.igw.id", "aws_internet_gateway.igw"]}}]},
     ["id", "vpc_id", "route"]),
    ...
    ("aws_route_table", "b_public", {"tags": {"Name": "zpa-lab-b-public-rt"}},
     {"vpc_id": {"references": ["aws_vpc.b.id", "aws_vpc.b"]},
      "route": [{"cidr_block": {"constant_value": "0.0.0.0/0"}, "gateway_id": {"references": ["aws_internet_gateway.b.id", "aws_internet_gateway.b"]}}]}, ["id", "vpc_id", "route"]),
    ("aws_route_table", "b_private", {"tags": {"Name": "zpa-lab-b-private-rt"}},
     {"vpc_id": {"references": ["aws_vpc.b.id", "aws_vpc.b"]},
      "route": [{"cidr_block": {"constant_value": "0.0.0.0/0"}, "nat_gateway_id": {"references": ["aws_nat_gateway.b.id", "aws_nat_gateway.b"]}}]}, ["id", "vpc_id", "route"]),
